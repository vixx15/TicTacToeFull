...
def play_action_logic(
    ...
    return pt.Seq(
        [
            ...
            # getBoardState(),
            pt.Cond(
                [app.state.game_status == pt.Int(0), output.set(app.state.board_state)],
                [
                    ...
                    [
                        ...
                        .Then(
                            pt.Seq(
                                app.state.board_state.set(
                                    pt.Concat(
                                        app.state.board_state.get(), pt.Bytes("X")
                                    )
                                )
                            )
                        )
                        ...
                        .Then(
                            pt.Seq(
                                app.state.board_state.set(
                                    pt.Concat(
                                        app.state.board_state.get(), pt.Bytes("O")
                                    )
                                )
                            )
                        )
                        ...
                        pt.If(
                            pt.Or(
                                brojac.load() == pt.Int(2),
                                brojac.load() == pt.Int(5),
                                brojac.load() == pt.Int(8),
                            )
                        ).Then(
                            app.state.board_state.set(
                                pt.Concat(app.state.board_state.get(), pt.Bytes("\n"))
